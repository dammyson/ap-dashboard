  ...
  ({ value, onClick, onChange }, ref) => (
    <div className='relative'>
      <input
        ...
        onChange={onChange}
        onClick={onClick}
        className='!rounded-full w-full !h-11 pr-14 border !border-light-grey-800 hover:!border-light-blue-50 focus:!border-light-blue-50 focus:ring-0 focus:outline-none'
      />
      <span
